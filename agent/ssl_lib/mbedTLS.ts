...
export class mbed_TLS {
    ...
    parse_mbedtls_ssl_context_struct(sslcontext: NativePointer) {
        return {
    ...
    Interceptor.attach(this.addresses["mbedtls_ssl_read"], {
        onEnter: function(args){
            ...
            var message = getPortsAndAddresses(this.getSocketDescriptor(args[0]) as number, true, this.addresses)
    ...
    Interceptor.attach(this.addresses["mbedtls_ssl_write"], {
        ...
        onEnter: function(args){
            ...
            var message = getPortsAndAddresses(this.getSocketDescriptor(args[0]) as number, false, this.addresses)
            message["ssl_session_id"] = this.getSessionId(args[0])
