...
import {WolfSSL } from "../../libs/wolfssl.js";
import { socket_library } from "../../../platforms/android.js";
import { toHexString, executeSSLLibrary } from "../../../shared/shared_functions.js";
...
export function wolfssl_execute(moduleName:string, is_base_hook: boolean){
    executeSSLLibrary(WolfSSL_Android, moduleName, socket_library, is_base_hook);
}