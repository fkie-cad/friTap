import { readAddresses, resolveOffsets, executeSSLLibrary } from "../../../shared/shared_functions.js";
...
export class SSPI_Windows {
    ...
    constructor(public moduleName:string, public socket_library:String, is_base_hook: boolean){
        ...
        resolveOffsets(this.addresses, this.module_name, socket_library, "sspi");
...
export function sspi_execute(moduleName:string, is_base_hook: boolean){
    executeSSLLibrary(SSPI_Windows, moduleName, socket_library, is_base_hook);
}