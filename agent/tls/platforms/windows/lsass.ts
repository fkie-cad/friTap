import { readAddresses, getBaseAddress, executeSSLLibrary } from "../../../shared/shared_functions.js";
...
export function lsass_execute(moduleName:string, is_base_hook: boolean){
    executeSSLLibrary(LSASS_Windows, moduleName, socket_library, is_base_hook);
}