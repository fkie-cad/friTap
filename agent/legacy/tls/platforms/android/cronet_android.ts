...
const LIBSIGNAL_PATTERNS = {
    "arm64": {
        ...
        // ssl_log_secret prologue for modern libsignal-net BoringSSL (Signal
        // Android >= ~7.52.0; BoringSecretHunter on libsignal_jni.so 8.14.3 arm64).
        // LEGACY-SYNC with agent/shared/bundled_cronet_patterns.ts SIGNAL.arm64.
        second_fallback: "FF 83 02 D1 FD 7B 05 A9 F9 33 00 F9 F8 5F 07 A9 F6 57 08 A9 F4 4F 09 A9 FD 43 01 91 59 D0 3B D5 28 17 40 F9 A8 83 1F F8 08 34 40 F9 08 21 41" // Signal >=7.52 / 8.x
    }
};
