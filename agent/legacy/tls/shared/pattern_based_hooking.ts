...
export { hasModulePatterns, hasUsablePatternsFor } from "../../../tls/shared/cronet_patterns.js";
...
export function get_CPU_specific_pattern(
    ...
    // the same library (callers treat null/empty as "nothing to scan" and no-op).
