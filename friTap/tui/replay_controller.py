...
"""
Replay controller for .tap file replay mode.

Provides the IFlowSource protocol and a ReplayController that loads
flows from a .tap file for display in the TUI flow view.
"""
