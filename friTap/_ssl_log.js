...
7311 /agent/android/rustls_android.js.map
12438 /agent/android/rustls_android.js
...
export class Rustls_Linux extends RusTLS {
    ...
    install_key_extraction_hook_tls13() {
        ...
        if (isPatternReplaced()) {
            ...
            hooker.hookModuleByPatternOnReturn(
            // Pick the default pattern based on whether it’s “ex”
            get_CPU_specific_pattern(isEx ? this.default_pattern_ex : this.default_pattern), isEx ? exPatternCallback : normalPatternCallback, isX64 ? 9 : 7);
        }
    }
    execute_hooks() {
        this.install_plaintext_read_hook();
